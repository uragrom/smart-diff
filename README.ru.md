...
## 📤 Публикация своего форка на GitHub

1. Создай репозиторий на GitHub.
2. Замени `uragrom` на свой логин в этом README, в [README.md](README.md) и в [pyproject.toml](pyproject.toml) (секция `[project.urls]`).
3. Запушь код и укажи описание и темы (например `git`, `ollama`, `cli`, `llm`, `code-review`) на странице репозитория.
